    ...
    public class CityCouncilLocaleFR : IDictionarySource
    {
            ...
            IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { LocaleKeys.Event_DeploiementWifi, "Le déploiement de la nouvelle génération de réseau sans fil à enfin une date officielle. Les démocrates, ayant par le passé oeuvré à une politique active d'aménagement du territoire dans le domaine, se félicitent des nouvelles possibilités économiques."},
                ...
                { LocaleKeys.Event_FraudeSubventionsCulture, "Soupçons de fraude sur les subventions culturelles : une association proche du Parti Démocrate est ciblée par un rapport d'audit." },
                 { LocaleKeys.Event_DétournementFondsPublics, "Scandale de détournement : des élus Républicains sont accusés d'avoir favorisé des entreprises privées lors d'appels d'offres publics." },
                 { LocaleKeys.Event_ConflitInteretUrbanisme, "Conflit d'intérêts au conseil : un responsable de la Gauche Radicale possède des parts dans un projet immobilier contesté." },
                 { LocaleKeys.Event_FuiteDonneesCitoyens, "Scandale numérique : une fuite massive de données personnelles secoue la mairie, la gestion des services informatiques est vivement critiquée." },
                 { LocaleKeys.Event_GreveTransportsCollectifs, "Grève générale dans les transports : le blocage des dépôts de bus par les syndicats paralyse le centre-ville et exaspère les usagers." },
                 { LocaleKeys.Event_PenurieLogementsEtudiants, "Pénurie critique de logements étudiants : la Gauche Radicale exige la réquisition de bâtiments vides face à la hausse des loyers." },
                 { LocaleKeys.Event_InaugurationParcEolien, "Inauguration d'un grand parc éolien périurbain : les Écolos saluent une avancée majeure, tandis que des riverains dénoncent une nuisance visuelle." },
                 { LocaleKeys.Event_PicPollutionAtmospherique, "Alerte rouge à la pollution : circulation différenciée imposée dans toute la métropole pour faire face au nuage de fines particules." },
                 ...
                 { LocaleKeys.Event_CaniculeExtreme, "Vague de chaleur historique : les hôpitaux frôlent la saturation et la demande en climatisation met à rude épreuve le réseau électrique." },
                 { LocaleKeys.Event_NuitSecuriteRoutiere, "Opération coup de poing de la police contre la vitesse nocturne : forte médiatisation saluée par les partisans de l'ordre public." },
                 { LocaleKeys.Event_EchecFestivalEcoResponsable, "Le festival zéro déchet vire au chaos logistique : les réseaux sociaux se moquent de la mauvaise organisation des promoteurs écologistes." },
                 { LocaleKeys.Event_SaisieHistoriqueDrogue, "Saisie record de stupéfiants dans les districts nord : les Populistes s'emparent de l'affaire pour réclamer une militarisation de la police." },
                 { LocaleKeys.Event_ManifestationTaxisThermiques, "Opération escargot des taxis contre l'extension des zones piétonnes : embouteillages monstres sur les grands boulevards." },
                 { LocaleKeys.Event_SuccesProjetTélétravail, "Succès des espaces de coworking municipaux : les Démocrates se félicitent du développement du télétravail et de la réduction du trafic routier." },
                ...
                { LocaleKeys.DistrictEvent_NuisancesChantierFermeture, "Chantier prolongé et rue bloquée : les commerçants du quartier expriment leur exaspération face aux retards du chantier. -3% pour le parti qui dirige ce district." },
                 ...
                 { LocaleKeys.DistrictEvent_SquatImmeubleAncien, "Occupation illégale d'un bâtiment vacant du quartier : la situation crée des tensions vives entre riverains et militants. Populiste +4% dans ce district." },
                 { LocaleKeys.DistrictEvent_RondeCitoyenneSécurité, "Création d'une milice citoyenne de surveillance nocturne : le sentiment d'insécurité grandit chez les habitants du quartier. Populiste +4% dans ce district." },
                 { LocaleKeys.DistrictEvent_SuccesVideGrenierQuartier, "Grand succès populaire pour le marché aux puces du quartier : les résidents saluent une ambiance conviviale et dynamique." },
                 { LocaleKeys.DistrictEvent_ScandalePermisConstruire, "Permis de construire suspect : la majorité locale dans ce district est accusée d'avoir délivré une autorisation de complaisance." },
                 { LocaleKeys.DistrictEvent_SoupçonPriseInteretEluLocal, "Soupçons de prise illégale d'intérêts : un conseiller de quartier aurait favorisé la société de rénovation de son conjoint." },
                 { LocaleKeys.DistrictEvent_RivaliteInterneGauche, "Guerre de factions à la section locale de la Gauche Radicale : accusations de tripatouillage des votes lors de la primaire de quartier." },
                 { LocaleKeys.DistrictEvent_DétournementCaisseFete, "Trésorerie évaporée au comité des fêtes du quartier : la majorité locale est pointée du doigt pour son manque de contrôle." },
                 { LocaleKeys.DistrictEvent_RénovationPisteCycable, "Inauguration d'une piste cyclable sécurisée traversant le quartier : satisfaction générale des associations de mobilités douces." },
                 { LocaleKeys.DistrictEvent_FermetureClasseMaternelle, "Annonce de la fermeture d'une classe dans l'école du quartier : manifestation des parents d'élèves contre la détérioration des services." },
                 { LocaleKeys.DistrictEvent_InaugurationZoneArtisanale, "Ouverture d'une pépinière d'entreprises locales : les artisans saluent un coup de pouce bienvenu pour l'économie du quartier." },
                 { LocaleKeys.DistrictEvent_AlerteDegatEauxCommerces, "Rupture d'une canalisation majeure d'eau potable : plusieurs sous-sols de boutiques inondés et colère contre la gestion des infrastructures." },
                 { LocaleKeys.DistrictEvent_CollectePropreteQuartier, "Opération 'Quartier Propre' organisée par des résidents : mobilisation citoyenne massive pour ramasser les déchets sauvages." },
