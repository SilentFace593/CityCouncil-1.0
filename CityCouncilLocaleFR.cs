    ...
    public class CityCouncilLocaleFR : IDictionarySource
    {
            ...
            IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { LocaleKeys.DistrictEvent_NuisancesChantierFermeture, "Chantier prolongé et rue bloquée : les commerçants du quartier expriment leur exaspération face aux retards du chantier." },
                 { LocaleKeys.DistrictEvent_TensionsCommerçantsSeniors, "Problèmes de stationnement dans la zone commerciale du quartier : les seniors réclament des places réservées supplémentaires." },
                 { LocaleKeys.DistrictEvent_InaugurationCentreSocial, "Inauguration réussie d'une maison de quartier : les associations d'entraide félicitent la dynamique solidaire locale." },
                 { LocaleKeys.DistrictEvent_SquatImmeubleAncien, "Occupation illégale d'un bâtiment vacant du quartier : la situation crée des tensions vives entre riverains et militants." },
                 { LocaleKeys.DistrictEvent_RondeCitoyenneSécurité, "Création d'une milice citoyenne de surveillance nocturne : le sentiment d'insécurité grandit chez les habitants du quartier." },
