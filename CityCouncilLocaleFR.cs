    ...
    public class CityCouncilLocaleFR : IDictionarySource
    {
            ...
            IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { LocaleKeys.Hemicycle_IconTooltip, "Hémicycle" },
                { LocaleKeys.Hemicycle_TabResults, "Résultats" },
                { LocaleKeys.Hemicycle_TabYourParty, "Votre Parti" },
                { LocaleKeys.Hemicycle_YourPartyIconTooltip, "Votre Parti" },
                { LocaleKeys.Hemicycle_ForcesIconTooltip, "Forces Politiques" },
                { LocaleKeys.Hemicycle_FundingIconTooltip, "Financement" },
                { LocaleKeys.Hemicycle_PropagandaIconTooltip, "Propagande" },
                { LocaleKeys.Hemicycle_CommissionIconTooltip, "Commission Électorale" },
                { LocaleKeys.Hemicycle_PollIconTooltip, "Sondages" },
                { LocaleKeys.Hemicycle_LawsIconTooltip, "Lois" },
                { LocaleKeys.Hemicycle_ScoreIconTooltip, "Score" },
                { LocaleKeys.Hemicycle_RulesIconTooltip, "Règles" },
                ...
                { LocaleKeys.Forces_MostPowerfulDistrictSuffix, "District le plus puissant" },
                ...
                // City Events
                { LocaleKeys.Event_ScandalePolitique, "Un scandale politique éclate dans la ville, les citoyens sont désabusés ! Abstention +10% dans la ville." },
                { LocaleKeys.Event_IncendiesForets, "D'importants incendies ravagent des milliers d'hectares de forêts. Ecologiste +10% dans la ville." },
                { LocaleKeys.Event_ReformePensions, "Il se murmure dans les couloirs de la mairie un projet de réforme des pensions de retraite. Les séniors sont vent debout ! Parti au pouvoir -50% dans la ville." },
                { LocaleKeys.Event_PoliceBavure, "La police locale est accusée de bavure suite à l'arrestation musclée d'un individu. Le commissaire du district concerné défend ses agents, la procédure ayant été respectée selon lui. Gauche Radicale +5% dans la ville. " },
                { LocaleKeys.Event_RegionEconomieSante, "La région cherche encore de économies dans le système de santé, les directeurs d'hôpitaux sonnent l'alerte face au manque de moyens. Gauche Radila +10% dans la ville."},
                { LocaleKeys.Event_CacophonieGaucheRadicale, "Cacophonie dans les rangs de la Gauche Radicale, les leaders ont du mal à s'accorder pour les prochaines échéances électorales, notamment pour les district nord. Gauche Radicale -5% dans la ville."},
                { LocaleKeys.Event_InvestissementSecurite, "On annonce des investissements massifs dans le système sécuritaire de la ville, des idées portées de longue date par les Républicains, qui ne manquent pas de rappeler leur doctrine à ce sujet va bien plus loin. Républicains +5% dans la ville. "},
                { LocaleKeys.Event_EvolutionClimatImpact, "L'évolution du climat nous obligera tôt ou tard à des choix radicaux et éclairés, désormais la question n'est plus comment limiter l'impact mais comment s'adapter... Ecologistes +5% dans la ville."},
                { LocaleKeys.Event_DeploiementWifi, "Le déploiement de la nouvelle génération de réseau sans fil à enfin une date officielle. Les démocrates, ayant par le passé oeuvré à une politique active d'aménagement du territoire dans le domaine, se félicitent des nouvelles possibilités économiques. Démocrates +2% dans la ville. "},
                ...
                { LocaleKeys.Event_DurcissementNorme, "La Commission Régionale aux Transports annonce un nouveau durcissement des normes antipollutionpour les véhicules thermiques. Les associations d'automobilistes prévoient des manifestations à la rentrée, et les constructeurs automobiles alertent sur une trajectoire intenable. Populistes +10% dans la ville."},
                { LocaleKeys.Event_ScandaleDemocrate, "Scandale au Parti Démocrate : des documents financiers font état d'irrégularités dans les comptes de campagnes de certaines élections passées. Une enquête est ouverte. Démocrates -6% dans la ville."},
                { LocaleKeys.Event_ZIDeveloppement, "La Zone industrielle se développe à grande vitesse, au point que la municipalité va devoir réfléchir à la délimitation de nouvelles parcelles. Si les Républicains promettent de faciliter les négociations, les écologistes eux s'inquiètent de l'impact environemental à venir.Républicains et Ecologistes +5% dans la ville "},
                { LocaleKeys.Event_PopulisteAnimalMagazine, "la leader du Parti Populiste fait la Une du site internet Animal Magazine, en compagnie de ses chats et de son mari. succès garanti sur le rééseaux, renforçant la normalisation du parti. Populistes +2% dans la ville"},
                { LocaleKeys.Event_DesaccordEcoloDemocrateInegalites, "Les Écologistes ont un profond désaccord avec les Démocrates sur le plan de réduction des inégalités. Il n'est plus assuré que les Écologistes suivent autant les Démocrates en cas d'élimination au premier tour. Report des voix Ecologistes vers Démocrates réduit à 30%." },
                { LocaleKeys.Event_FraudeSubventionsCulture, "Soupçons de fraude sur les subventions culturelles : une association proche du Parti Démocrate est ciblée par un rapport d'audit. Démocrates -7% dans la ville." },
                 { LocaleKeys.Event_DétournementFondsPublics, "Scandale de détournement : des élus Républicains sont accusés d'avoir favorisé des entreprises privées lors d'appels d'offres publics. Républicains -8% dans la ville." },
                 { LocaleKeys.Event_ConflitInteretUrbanisme, "Conflit d'intérêts au conseil : un responsable de la Gauche Radicale possède des parts dans un projet immobilier contesté. gauche Radicale -6% dans la ville." },
                 { LocaleKeys.Event_FuiteDonneesCitoyens, "Scandale numérique : une fuite massive de données personnelles secoue la mairie, la gestion des services informatiques est vivement critiquée. Parti au pouvoir -8% et Abstention +5% dans la ville." },
                 { LocaleKeys.Event_GreveTransportsCollectifs, "Grève générale dans les transports : le blocage des dépôts de bus par les syndicats paralyse le centre-ville et exaspère les usagers. Gauche Radicale +8% chez les adulte et Républicains +4% dans la ville." },
                 { LocaleKeys.Event_PenurieLogementsEtudiants, "Pénurie critique de logements étudiants : la Gauche Radicale exige la réquisition de bâtiments vides face à la hausse des loyers. Gauche Radile +5% chez les adultes dans la ville." },
                 { LocaleKeys.Event_InaugurationParcEolien, "Inauguration d'un grand parc éolien périurbain : les Écolos saluent une avancée majeure, tandis que des riverains dénoncent une nuisance visuelle.Populistes +3% chez les séniors et Ecologistes +8% dans la ville." },
                 { LocaleKeys.Event_PicPollutionAtmospherique, "Alerte rouge à la pollution : circulation différenciée imposée dans toute la métropole pour faire face au nuage de fines particules. Ecologistes +10% dans la ville." },
                 { LocaleKeys.Event_SommetEconomiqueLocal, "Un grand sommet des entreprises s'ouvre en ville : les Républicains vantent l'attractivité fiscale alors que les opposants dénoncent un cadeau au grand capital." },
                 { LocaleKeys.Event_CaniculeExtreme, "Vague de chaleur historique : les hôpitaux frôlent la saturation et la demande en climatisation met à rude épreuve le réseau électrique. Ecologistes +6% dans la ville." },
                 { LocaleKeys.Event_NuitSecuriteRoutiere, "Opération coup de poing de la police contre la vitesse nocturne : forte médiatisation saluée par les partisans de l'ordre public. Républicains +3% chez les séniors et Populistes +3% dans la ville." },
                 { LocaleKeys.Event_EchecFestivalEcoResponsable, "Le festival zéro déchet vire au chaos logistique : les réseaux sociaux se moquent de la mauvaise organisation des promoteurs écologistes. Ecologistes -4% dans la ville." },
                 { LocaleKeys.Event_SaisieHistoriqueDrogue, "Saisie record de stupéfiants dans les districts nord : les Populistes s'emparent de l'affaire pour réclamer une militarisation de la police.Populistes +5% dans la ville." },
                 { LocaleKeys.Event_ManifestationTaxisThermiques, "Opération escargot des taxis contre l'extension des zones piétonnes : embouteillages monstres sur les grands boulevards. Populistes +4% et Ecologistes -3% dans la ville." },
                 { LocaleKeys.Event_SuccesProjetTélétravail, "Succès des espaces de coworking municipaux : les Démocrates se félicitent du développement du télétravail et de la réduction du trafic routier. Démocrates +4% dans la ville." },

                //District Events
                { LocaleKeys.DistrictEvent_TravauxVoirieRetard, "L'administration du district est bousculée par l'opposition au sujet des travaux de voirie hors délais. -3% pour le parti qui dirige ce district." },
                { LocaleKeys.DistrictEvent_MeetingPopuliste, "Les Populistes ont fait carton plein au meeting d'hier soir, Agatha Gilding a mis en avant la tête de liste pour les prochaines élections. +3% pour les Populistes dans ce district." },
                { LocaleKeys.DistrictEvent_ScandaleFavoritisme, "Une affaire de favoritisme dans l'attribution des marchés locaux éclabousse l'équipe en place. -5% pour le parti qui dirige ce district." },
                { LocaleKeys.DistrictEvent_PetitionVegetalisation, "Une pétition citoyenne pour la végétalisation du quartier rencontre un franc succès. +4% pour les Écologistes dans ce district." },
                { LocaleKeys.DistrictEvent_SecuriteQuartierSeniors, "Une opération de sécurité de quartier est saluée par les habitants les plus âgés. +3% pour les Républicains chez les séniors de ce district." },
                { LocaleKeys.DistrictEvent_TensionsGaucheRadicale, "Des tensions internes éclatent au sein de la section locale de la Gauche Radicale. -4% pour ce parti dans ce district." },
                { LocaleKeys.DistrictEvent_NuisancesChantierFermeture, "Chantier prolongé et rue bloquée : les commerçants du quartier expriment leur exaspération face aux retards du chantier. -3% pour le parti qui dirige ce district." },
                 { LocaleKeys.DistrictEvent_TensionsCommerçantsSeniors, "Problèmes de stationnement dans la zone commerciale du quartier : les seniors réclament des places réservées supplémentaires. Républicains +3% chez les séniors de ce district." },
                 { LocaleKeys.DistrictEvent_InaugurationCentreSocial, "Inauguration réussie d'une maison de quartier : les associations d'entraide félicitent la dynamique solidaire locale. Gauche Radicale +4% dans ce district." },
                 { LocaleKeys.DistrictEvent_SquatImmeubleAncien, "Occupation illégale d'un bâtiment vacant du quartier : la situation crée des tensions vives entre riverains et militants. Populistes +4% dans ce district." },
                 { LocaleKeys.DistrictEvent_RondeCitoyenneSécurité, "Création d'une milice citoyenne de surveillance nocturne : le sentiment d'insécurité grandit chez les habitants du quartier. Populistes +4% dans ce district." },
                 { LocaleKeys.DistrictEvent_SuccesVideGrenierQuartier, "Grand succès populaire pour le marché aux puces du quartier : les résidents saluent une ambiance conviviale et dynamique. Parti au pouvoir +3% dans ce district." },
                 { LocaleKeys.DistrictEvent_ScandalePermisConstruire, "Permis de construire suspect : la majorité locale dans ce district est accusée d'avoir délivré une autorisation de complaisance. Parti au pouvoir -5% dans ce district." },
                 { LocaleKeys.DistrictEvent_SoupçonPriseInteretEluLocal, "Soupçons de prise illégale d'intérêts : un conseiller de quartier aurait favorisé la société de rénovation de son conjoint. Parti au pouvoir -4% dans ce district." },
                 { LocaleKeys.DistrictEvent_RivaliteInterneGauche, "Guerre de factions à la section locale de la Gauche Radicale : accusations de tripatouillage des votes lors de la primaire de quartier. Gauche Radicale -5% dans ce district." },
                 { LocaleKeys.DistrictEvent_DétournementCaisseFete, "Trésorerie évaporée au comité des fêtes du quartier : la majorité locale est pointée du doigt pour son manque de contrôle. Parti au pouvoir -4% dans ce district." },
                 { LocaleKeys.DistrictEvent_RénovationPisteCycable, "Inauguration d'une piste cyclable sécurisée traversant le quartier : satisfaction générale des associations de mobilités douces. Écologistes +5% dans ce district." },
                 { LocaleKeys.DistrictEvent_FermetureClasseMaternelle, "Annonce de la fermeture d'une classe dans l'école du quartier : manifestation des parents d'élèves contre la détérioration des services. Parti au pouvoir -4% dans ce district." },
                 { LocaleKeys.DistrictEvent_InaugurationZoneArtisanale, "Ouverture d'une pépinière d'entreprises locales : les artisans saluent un coup de pouce bienvenu pour l'économie du quartier. Démocrates +3% dans ce district." },
                 { LocaleKeys.DistrictEvent_AlerteDegatEauxCommerces, "Rupture d'une canalisation majeure d'eau potable : plusieurs sous-sols de boutiques inondés et colère contre la gestion des infrastructures. Parti au pouvoir -3% dans ce district." },
                 { LocaleKeys.DistrictEvent_CollectePropreteQuartier, "Opération 'Quartier Propre' organisée par des résidents : mobilisation citoyenne massive pour ramasser les déchets sauvages. Écologistes +3% dans ce district." },
